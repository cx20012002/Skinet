...
function Shop() {
    ...
    if (isProductsFetching || isBrandsFetching || isTypesFetching) {
        return <Loading content='Loading Products...'/>;
    }
    ...
    return (
        <>
            <div className="w-full flex justify-center"><Breadcrumb/></div>
                    ...
                    <div className="flex items-center justify-between py-2 mb-3">
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            <button onClick={handleSearchSubmit}
                                    className="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600">Search
                            </button>
                            <button onClick={resetFilters}
                                    className="bg-gray-500 text-white px-4 py-2 rounded-md hover:bg-gray-600">Reset
                            </button>
                        </div>
                    </div>
